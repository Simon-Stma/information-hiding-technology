...
%插入图片    
    ...
    \includegraphics[scale=0.8]{D:/Program Files/MikTex/documents/figure/图1.jpg}%tex文件夹下的相对路径
    \caption{信息隐藏系统的一般模型}
    \end{figure}
    ...
    \begin{figure}[!ht]\centering   %添加图片环境的配置
    \includegraphics[scale=0.8]{D:/Program Files/MikTex/documents/figure/图2.jpg}%tex文件夹下的相对路径
    \caption{信息隐藏的主要分支}
    \end{figure}
    ...
    \begin{figure}[!ht]\centering   %添加图片环境的配置
    \includegraphics[scale=0.8]{D:/Program Files/MikTex/documents/figure/图3.jpg}%tex文件夹下的相对路径
    \caption{GAN模型}
    \end{figure}
...
%插入表格
    ...
    \begin{figure}[!ht]\centering   %添加图片环境的配置
	\includegraphics[scale=0.8]{D:/Program Files/MikTex/documents/figure/图4.jpg}%tex文件夹下的相对路径
